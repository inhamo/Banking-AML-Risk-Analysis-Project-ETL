/*************************************************************************************
Script		: create_customer_normalized_tables.sql
...
BEGIN
	...
	***********************************************/
	...
	IF OBJECT_ID('silver.dim_documents', 'U') IS NOT NULL 
	BEGIN 
		DROP TABLE silver.dim_documents;
		PRINT 'Dropped the silver.dim_documents';
	END;

	IF OBJECT_ID('silver.dim_contacts', 'U') IS NOT NULL 
	BEGIN 
		DROP TABLE silver.dim_contacts; 
		PRINT 'Dropped the silver.dim_contacts';
	END;

	IF OBJECT_ID('silver.dim_addresses', 'U') IS NOT NULL 
	BEGIN 
		DROP TABLE silver.dim_addresses; 
		PRINT 'Dropped the silver.dim_addresses';
	END;
	...
	***********************************************/
	...
	CREATE TABLE silver.fact_customers (
		...
		fixed_date_of_birth DATE NOT NULL, 
		original_age_at_opening INT NOT NULL, 
		fixed_age_at_opening INT NOT NULL, 
		...
		age_group NVARCHAR(50) CHECK(age_group IN (
				'YOUNG ADULT', 'EARLY CAREER', 'ESTABLISHED PROFESSIONAL', 'MID-CAREER', 
				'PRE-RETIREMENT', 'RETIREES', 'STARTUP','1 YEAR OLD','2 YEARS OLD', 
				'3-5 YEARS OLD','6-10 YEARS OLD','11-20 YEARS OLD','21-50 YEARS OLD','OVER 50 YEARS OLD'
			)),
	...
	CREATE TABLE silver.dim_addresses (
		...
		is_primary_address BIT DEFAULT 1,
		effective_date DATE, 
	...
	CREATE TABLE silver.dim_business_details (
		...
		number_of_employees NVARCHAR(20), 
		director_count NVARCHAR(20), 
		annual_turnover DECIMAL(15, 2), 
		shareholder_count NVARCHAR(20), 
		bee_level NVARCHAR(20), 
		vat_registered NVARCHAR(20), 
		...
		num_branches_foreign NVARCHAR(20),	
		num_subsidiaries_local NVARCHAR(20),
		num_subsidiaries_foreign NVARCHAR(20),
	...
	CREATE TABLE silver.dim_business_licensing (	
		...
		license_regulatory_body NVARCHAR(MAX),
		created_date DATETIME2 DEFAULT GETDATE(), 
		update_date DATETIME2 DEFAULT GETDATE(), 
